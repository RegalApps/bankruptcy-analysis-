...
export const ViewerLayout: React.FC<ViewerLayoutProps> = ({
  ...
  return (
    <div className="h-full flex flex-col md:grid md:grid-cols-12 overflow-hidden">
      ...
      <div className={`${isForm47 ? 'md:col-span-3 lg:col-span-3' : 'md:col-span-3 lg:col-span-2'} h-full overflow-auto border-r border-border/50 bg-white dark:bg-background`}>
        {sidebar}
      </div>
      
      {/* Center Panel - Document Viewer */}
      <div className={`${isForm47 ? 'md:col-span-6 lg:col-span-6' : 'md:col-span-6 lg:col-span-7'} h-full overflow-auto border-r border-border/50 bg-white dark:bg-muted/10`}>
