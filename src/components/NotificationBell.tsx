      ...
      try {
        ...
        const transformedNotifications: Notification[] = data.map(dbNotification => {
          ...
          return {
            ...
            description: dbNotification.message || '', // Convert message to description
            createdAt: dbNotification.created_at,
            created_at: dbNotification.created_at, // Keep for backward compatibility
            read: dbNotification.read,
            type: dbNotification.type,
            priority: dbNotification.priority || 'low',
            actionUrl: dbNotification.action_url || '',
            action_url: dbNotification.action_url || '', // Keep for backward compatibility
            message: dbNotification.message || '', // Keep for backward compatibility
      ...
      .on('postgres_changes', {
        ...
        if (user && payload.new.user_id === user.id) {
          ...
          const newNotification: Notification = {
            ...
            description: newDbNotification.message || '',
            createdAt: newDbNotification.created_at,
            created_at: newDbNotification.created_at, // Keep for backward compatibility
            read: newDbNotification.read,
            type: newDbNotification.type,
            priority: newDbNotification.priority || 'low',
            actionUrl: newDbNotification.action_url || '',
            action_url: newDbNotification.action_url || '', // Keep for backward compatibility
            message: newDbNotification.message || '', // Keep for backward compatibility
